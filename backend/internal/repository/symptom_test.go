...
func TestSymptomRepository_Create(t *testing.T) {
	...
	symp := symptom.NewSymptom("user1", "Headache", 7, time.Now())

	created, err := repo.Create(ctx, symp)
	if err != nil {
...
func TestSymptomRepository_GetByID(t *testing.T) {
	...
	symp := symptom.NewSymptom("user1", "Nausea", 5, time.Now())
	created, _ := repo.Create(ctx, symp)
...
func TestSymptomRepository_GetByUserID(t *testing.T) {
	...
	symptom1 := symptom.NewSymptom("user1", "Headache", 1, time.Now())
	symptom2 := symptom.NewSymptom("user1", "Nausea", 2, time.Now())
	symptom3 := symptom.NewSymptom("user2", "Pain", 3, time.Now())
...
func TestSymptomRepository_Update(t *testing.T) {
	...
	symp := symptom.NewSymptom("user1", "Original", 3, time.Now())
	created, _ := repo.Create(ctx, symp)
...
func TestSymptomRepository_Delete(t *testing.T) {
	...
	symp := symptom.NewSymptom("user1", "To Delete", 4, time.Now())
	created, _ := repo.Create(ctx, symp)
...
func TestSymptomRepository_GetByUserIDAndDateRange(t *testing.T) {
	...
	symptom1 := symptom.NewSymptom("user1", "Yesterday", 2, yesterday)
	symptom2 := symptom.NewSymptom("user1", "Today", 3, now)
	symptom3 := symptom.NewSymptom("user1", "Tomorrow", 4, tomorrow)
...
func TestSymptomRepository_GetByUserIDAndCategory(t *testing.T) {
	...
	symptom2 := symptom.NewSymptom("user1", "Other Issue", 4, time.Now())
	// No category set
...
func TestSymptomRepository_GetByUserIDAndType(t *testing.T) {
	...
	symptom1 := symptom.NewSymptom("user1", "Nausea Symptom", 6, time.Now())
	symptom1.Type = &symptomType

	symptom2 := symptom.NewSymptom("user1", "Other Symptom", 3, time.Now())
	// No type set
