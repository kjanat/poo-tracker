...
export function initializeServices(): void {
  ...
  // API client
  container
    .bind(SERVICE_IDENTIFIERS.API_CLIENT)
    .toFactory(() => {
  ...
  // Domain services
  container
    .bind(SERVICE_IDENTIFIERS.ENTRY_SERVICE)
    .toFactory(() => {
  ...
  container
    .bind(SERVICE_IDENTIFIERS.MEAL_SERVICE)
    .toFactory(() => {
      const apiClient = container.get<ApiClient>(SERVICE_IDENTIFIERS.API_CLIENT)
  ...
  container
    .bind(SERVICE_IDENTIFIERS.ANALYTICS_SERVICE)
    .toFactory(() => {
      const apiClient = container.get<ApiClient>(SERVICE_IDENTIFIERS.API_CLIENT)
